...
public class SpedizioneAssicurata extends Spedizione {
    ...
    //Costruttore della spedizione assicurata con stato passato per parametro
    ...
    //Costruttore della spedizione assicurata con stato settato dalla classe padre
    public SpedizioneAssicurata(String user, float peso, Date data, String destinazione,
    ...
    public boolean SpedizioneTerminata() {
        return getStato().equals("RIMBORSO_EROGATO");
    }
}
